class AW_groupMenu : RscDisplayTeamSwitch
{
	idd=9702;
	name="AW_groupMenu";
	movingEnable=0;
	...
	class Controls : Controls
	{
		...
		{
			text = "$STR_AW_Role_Menu_Title";
		};
		class RoleList : RscTree
		{
			idc = 1500;
			onTreeSelChanged = "_this call AW_fnc_onGroupMenuTvSelectChange;";
		...
		class SelectRoleBtn : CA_ButtonContinue
		{
			...
			onButtonClick = "[] call AW_fnc_selectPosition;";
		};
	};
};