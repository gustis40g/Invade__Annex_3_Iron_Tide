...
AW_OPFOR_side_rescuePilot_wreckType = "Land_Wreck_Heli_Attack_01_F";
AW_OPFOR_side_rescuePilot_pilotUniformVestHelmet = ["U_B_HeliPilotCoveralls", "V_PlateCarrier1_blk", "H_PilotHelmetHeli_B"];
...
AW_OPFOR_side_convoyProtectionVehicles = ["B_APC_Wheeled_01_cannon_F", "B_MRAP_01_hmg_F"];
AW_OPFOR_side_convoyTransportVehicles = ["B_MRAP_01_F", "B_Truck_01_covered_F", "B_Truck_01_medical_F", "B_Truck_01_box_F"];
