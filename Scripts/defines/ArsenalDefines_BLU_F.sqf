...
InA_AllowedArsenal_generalFacewear = [
    ...
    "G_AirPurifyingRespirator_02_sand_F","G_Balaclava_BlueStrips","G_Balaclava_combat","G_Balaclava_Flecktarn","G_Balaclava_Halloween_01",
	"G_Balaclava_lowprofile","G_Balaclava_oli","G_Balaclava_Flames1","G_Balaclava_Scarecrow_01","G_Balaclava_Skull1","G_Balaclava_Tropentarn"
];
...
InA_AllowedArsenal_generalBackpacks = [
    ...
    "B_FieldPack_green_F", "B_AssaultPack_eaf_F", "B_Carryall_eaf_F", "B_Carryall_taiga_F", "B_Carryall_blk", "B_FieldPack_taiga_F", "B_SCBA_01_F",
